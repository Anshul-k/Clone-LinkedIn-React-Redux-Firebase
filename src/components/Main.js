    ...
    <>
      {
        props.articles.length === 0 ?
          ...
          <Container>
            ...
            <Content>
              {props.loading && <img src='./images/spin-loader.svg' alt='spin-loader' />}
              {props.articles.length > 0 &&
                props.articles.map((article, key) => (
                  <Article key={key}>
                    ...
                    <SocialCounts>
                      <li>
                        <button>
                          ...
                          <img src="https://static-exp1.licdn.com/sc/h/5thsbmikm6a8uov24ygwd914f" alt="Celebrate" />
                          <span>75</span>
                        </button>
                      </li>
                      <li>
                    ...
                    <SocialActions>
                      ...
                      <button>
                        <img src="/images/comments-icon.png" alt="comments icon" />
                        <span>Comments</span>
                      </button>
                      <button>
